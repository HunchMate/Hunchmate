...
export default function CreateEvent() {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      fee: targetEvent.fee || '',
      prizeType: targetEvent.prizeType || 'pool',
      prizePool: targetEvent.prizePool || '',
      firstPrize: targetEvent.firstPrize || '',
      secondPrize: targetEvent.secondPrize || '',
      thirdPrize: targetEvent.thirdPrize || '',
