                  ...
                  return (
                    ...
                    >
                      <Card className="explore-card h-full flex flex-col overflow-hidden hover:shadow-lg transition-shadow duration-200">
                        <div
                          className="explore-card__image relative h-40 w-full flex-shrink-0 bg-cover bg-center"
                          style={
                            posterImage
                              ? {
                                  backgroundImage: `url(${posterImage})`,
                        ...
                        >
                          <div className="explore-card__veil absolute inset-0 bg-gradient-to-b from-black/10 to-black/60" />
                          {event.featured ? (
                            <div className="explore-card__badge absolute top-3 left-3 z-10 inline-flex items-center gap-1 rounded-lg bg-orange-500 text-white text-xs font-bold px-2 py-1">
                              <Star size={11} /> Featured
                            </div>
                          ) : null}
                        </div>

                        <div className="explore-card__body flex flex-col flex-1 justify-center">
                        <CardContent className="explore-card__content p-3.5">
                          <div className="explore-card__copy">
                            <span className="explore-card__eyebrow">
                              {event.category || 'Event'}
                            </span>
                            <h3 className="explore-card__title line-clamp-2">
                              {String(event.title || '')}
                            </h3>
                            <p className="explore-card__description line-clamp-2">
                              Hosted by {resolveOrganizerName(event)}
                            </p>
                          </div>
                        ...
                        <CardFooter className="explore-card__footer p-3.5 pt-1 flex items-center justify-end">
                          <button className="bg-blue-600 hover:bg-blue-700 text-white text-[11px] font-semibold px-3 py-1.5 rounded-lg transition-colors duration-200">
                            Register Now
                          </button>
                        </CardFooter>
                        </div>
