    ...
    <div className="orgx-page">
      ...
      <section className="container orgx-shell">
        ...
        <div className="orgx-tabs" role="tablist" aria-label="Organizer sections">
          ...
          <button type="button" className={activeTab === 'events' ? 'is-active' : ''} onClick={() => setActiveTab('events')}>My Events</button>
          <button type="button" className={activeTab === 'notifications' ? 'is-active' : ''} onClick={() => setActiveTab('notifications')}>
            Notifications {unreadNotifications > 0 ? `(${unreadNotifications})` : ''}
          </button>
          <button type="button" className={activeTab === 'scanner' ? 'is-active' : ''} onClick={() => setActiveTab('scanner')}>QR Scanner</button>
          <button type="button" className={activeTab === 'credentials' ? 'is-active' : ''} onClick={() => setActiveTab('credentials')}>Credentials</button>
        </div>
